...
- Crear una plataforma de uso sencillo que permita a los trabajadores plasmar experiencias y soluciones, a través de documentos, videos y música, y que esa información sea accesible a otros trabajadores de la misma empresa, de esta manera conservar el conocimiento en las empresas.

2. Especifique tres **objetivos específicos**, recordándose que deben ser medibles, cuantificables y logrables.

**Objetivos específicos**

- Que las publicaciones hayan sido leídas en conjunto 1000 veces cada quincena.
- Que se publiquen cada semana 20 nuevos sujetos.
- Que las valoraciones muestran que las publicaciones en promedio alcanzan un valor positivo de 80%.
